...
<table class="table">
  <thead>
    <tr>
      ...
      <th scope="col">Do you want to remove this from your cart</th>
    </tr>
  </thead>

<?php
include('config.php');
$cart="SELECT pname,cname,price FROM cart WHERE email='$email'";
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $cart_row['cname']; ?></td>
      <td>Rs. <?php echo $cart_row['price']; ?></td>
      <td><button class="btn btn-primary"><a href="remove.php" style="color: white;">Remove</a></button></td>
    </tr>
    <?php
    $sum=$sum+$cart_row['price'];
        }
    ?>
    <tr>
        <td></td>
...
<button class="btn btn-primary" style="float: right;"><a href="checkout.php" style="color: white;">Checkout</a></button>
