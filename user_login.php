...
$name="SELECT fname FROM signup WHERE email='$email'";
$name_result=mysqli_query($con,$name) or die(mysqli_error($con));
                                    ...
                                    <nav class="navigation-menu navigation-menu--text_white">
                                        <ul>
                                            ...
                                            <li class="has-children has-children--multilevel-submenu">
                                                ...
                                                <!-- multilevel submenu -->
                                                <ul class="submenu">
                                                    <li><a href="#"><span>Welcome <?php echo $name_row['fname']; ?></span></a></li>
                    ...
                    <div class="swiper-wrapper">
                                ...
                                <div class="new_card_infobox">
                                    ...
                                    <div class="new_card_info">
                                                ...
                                                <a href="https://www.techjockey.com/category/call-recording-software" target="_blank">Call Recording Software</a></p>
                                                                                <p class="card_title">
                                            <a href="https://www.techjockey.com/detail/spyhuman" target="_blank" onclick="track_event_new('Home','Clicked on Product from Seo Trending Products','SpyHuman',1)">SpyHuman</a>
                                        </p>
                                                                                    <p class="card_review">
                                ...
                                <div class="new_card_btns">
                                                                            <button name="Add to Cart" class="add_to_cart" data-slug="spyhuman" data-gacat="Home" data-gaaction="Clicked on Add to Cart from Seo Trending Products" data-galable="SpyHuman" data-gavalue="1">Add to Cart</button>
                                ...
                                <div class="new_card_btns">
                                                                            <button name="Add to Cart" class="add_to_cart" data-slug="tally-erp-9" data-gacat="Home" data-gaaction="Clicked on Add to Cart from Seo Trending Products" data-galable="Tally.ERP 9" data-gavalue="3">Add to Cart</button>
