...
include('config.php');
$email=$_SESSION['email'];
$user="SELECT fname FROM signup WHERE email='$email'";
            ...
            <p class="homePage_headings deals_heading top_trending_heading">Top Trending Products</p>
                    ...
                    <div class="swiper-wrapper">
                                ...
                                <div class="new_card_btns">
                                                                            <button name="Add to Cart" class="add_to_cart" data-slug="spyhuman" data-gacat="Home" data-gaaction="Clicked on Add to Cart from Seo Trending Products" data-galable="SpyHuman" data-gavalue="1"><a href="add_to_cart.php" style="color: white;">Add to Cart</a></button>

                                                                            <?php
                                                                            $pname=$details_row['pname'];
                                                                            $cname=$details_row['cname'];
                                ...
                                <div class="new_card_btns">
                                                                            <button name="Add to Cart" class="add_to_cart" data-slug="tally-erp-9" data-gacat="Home" data-gaaction="Clicked on Add to Cart from Seo Trending Products" data-galable="Tally.ERP 9" data-gavalue="3">Add to Cart</a></button>
